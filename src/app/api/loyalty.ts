...
const Loyaltys = {
  ...
  getAll: (search: string): Promise<ILoyaltyList[]> => requests.get(`loyalty/all/${!search ? "all" : search}`),
  getActive: <Type extends ILoyaltyList>(): Promise<Type[]> => requests.get(`loyalty/active`),
