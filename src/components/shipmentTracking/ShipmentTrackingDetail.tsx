  ...
  return (
    <Fragment>
      <Spin spinning={loading}>
        ...
        <br />
        <Row>
          <Col md={8}>Numero de Seguimiento: {shipment?.seguimiento}</Col>
          <Col md={8}>Ruta: {shipment?.ruta}</Col>
          <Col md={8}>Nombre: {shipment?.nombre}</Col>
        </Row>
        <Row>
          <Col md={11}>
            <div
          ...
          <Col md={11}>
            ...
            >
              <Row>
                ...
                {shipment?.fechaEnestimada.format("MMMM D, YYYY")}
                <br />
                Hora de entrega estimada:{" "}
                {shipment?.horaEnestimada.utc().format("h:mmA")}
                <br />
                Fecha de entrega real:
                {shipment?.fechaEnreal.format("MMMM D, YYYY") ==
                "Fecha inválida"
                  ? ""
                  : shipment?.fechaEnreal.format("MMMM D, YYYY")}
                <br />
                Hora de entrega real:{" "}
                {shipment?.horaEnreal.utc().format("h:mmA") == "Fecha inválida"
                  ? ""
                  : shipment?.horaEnreal.utc().format("h:mmA")}
              </Row>
            </div>
          </Col>
        </Row>
