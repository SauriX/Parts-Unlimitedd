...
import {
  AppointmentGeneralesFormDomValues,
...
const GeneralesDomForm: FC<GeneralesFormProps> = ({
  printing,
  generales,
  data,
  branchId,
  ...
  const [values, setValues] = useState<generalDomicilio>(
    new AppointmentGeneralesFormDomValues()
  );
        ...
        <Row gutter={[0, 12]}>
          ...
          <Col span={3}>
            <Button
              ...
              onClick={() => {
                if (type == "Whatsapp") {
                  sendTestWhatsapp("dom", id, values.whatssap);
                }
                if (type == "Email") {
                  sendTestEmail("dom", id, values.whatssap);
                }
                if (type == "Ambos") {
                  sendTestWhatsapp("dom", id, values.whatssap);
                  sendTestEmail("dom", id, values.whatssap);
