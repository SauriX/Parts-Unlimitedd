import { Spin, Form, Row, Col, Button, PageHeader, Divider } from "antd";
...
import { IReportFilter, ReportFilterValues } from "../../../../app/models/report";
...
const PruebaForm: FC<PruebaFormProps> = ({ /*id*/ componentRef, printing, reportName }) => {
  ...
  // const {BranchOptions,getBranchOptions,medicOptions: MedicOptions, getMedicOptions,companyOptions: CompanyOptions,getCompanyOptions} = optionStore;
  ...
  // );
  // const [values] = useState<IReportFilter>(new ReportFilterValues());
  ...
  // const onFinish = async (newValues: IReportFilter) => {
  //   setLoading(true);
