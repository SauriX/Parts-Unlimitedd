...
import { IPatientStatisticForm, PatientStatisticFormValues } from "../../../../app/models/patient_statistic";
...
const PatientStatsForm: FC<StatsFormProps> = ({ componentRef, printing, reportName }) => {
  return <div></div>;
