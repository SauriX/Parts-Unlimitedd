  ...
  return (
    <PageHeader
      ...
      extra={[
        ...
        <Search key="search" placeholder="Buscar" onSearch={(value) => {navigate(`/sucursales?search=${value}`);}} />,
        <Button key="new" type="primary" onClick={() => {navigate("new-sucursal");}} icon={<PlusOutlined />}>
          Nuevo
        </Button>,
      ]}
    ></PageHeader>
